...
citation: "Pub. L. 94-579, § 102, 90 Stat. 2744 (1976); codified at 43 U.S.C. § 1701(a)–(b)"
source:
  name: "Cornell Legal Information Institute"
  url: "https://www.law.cornell.edu/uscode/text/43/1701"
  retrieved: 2026-06-04
altSources:
  - name: "GPO govinfo.gov (original Statutes at Large)"
    url: "https://www.govinfo.gov/app/details/STATUTE-90/STATUTE-90-Pg2743"
    note: "Original 1976 act as enacted (PDF, image-only). No substantive amendments to § 102."
  - name: "Congress.gov — S. 507 (94th Cong.)"
    url: "https://www.congress.gov/bill/94th-congress/senate-bill/507"
    note: "Bill-history metadata: sponsorship (Sen. Henry M. Jackson), committee referrals, floor action, public-law assignment. Bill text PDF only."
provenance: |
  Subsections (a) and (b) transcribed from Cornell LII's codified text
  of 43 U.S.C. § 1701. Numbering and capitalization preserved as in the
  source. The Cornell text reflects the original 1976 act for these
...
1.  {{< gloss id="retention-default" >}}the public lands be retained in Federal ownership{{< /gloss >}}, unless as a result of the land use planning procedure provided for in this Act, it is determined that disposal of a particular parcel will serve the national interest;
...
7.  goals and objectives be established by law as guidelines for public land use planning, and that management be on the basis of {{< gloss id="multiple-use" >}}multiple use and sustained yield{{< /gloss >}} unless otherwise specified by law;
...
11. regulations and plans for the protection of {{< gloss id="acec" >}}public land areas of critical environmental concern{{< /gloss >}} be promptly developed;
...
{{< glossbody id="retention-default" >}}
This single clause is one of the most consequential in modern public-lands law. It reverses the default that had governed federal land policy since the Land Ordinance of 1785 and the General Land Office: that public lands existed to be disposed of, granted, sold, or otherwise transferred out of federal ownership. The 1970 *One Third of the Nation's Land* report from the Public Land Law Review Commission had still framed disposal as legitimate; FLPMA's drafters chose a different default. Retention became the rule; disposal the exception requiring affirmative planning justification.

The Sagebrush Rebellion that erupted three years later was, in significant part, a reaction against this single sentence.
{{< /glossbody >}}

{{< glossbody id="multiple-use" >}}
"Multiple use" as a statutory doctrine came from the Multiple-Use Sustained-Yield Act of 1960 (MUSY, P.L. 86-517), which had codified the doctrine for the Forest Service. FLPMA extended the same framework to BLM lands, giving the Bureau its first explicit statutory authority to manage for a balance of grazing, mineral extraction, recreation, watershed, wildlife, and timber — none of which had a presumptive priority. The doctrine has been the field of recurring legal and political contest ever since; what counts as a legitimate "use," and how to weigh them, has no settled answer.
{{< /glossbody >}}

{{< glossbody id="acec" >}}
Areas of Critical Environmental Concern (ACECs) are a FLPMA innovation, designated through the land-use planning process under § 202(c)(3). Unlike Wilderness or Wild and Scenic River designations, ACECs are administrative — the Secretary can create or modify them without further congressional action. The category has been used inconsistently across administrations: heavily by the Carter and Clinton BLMs, lightly by the Reagan and George W. Bush BLMs, with renewed interest in the Biden BLM's *Public Lands Rule* (2024). The ACEC designation is one of the principal tools through which contemporary land-use planning argues over what is "critical."
{{< /glossbody >}}
