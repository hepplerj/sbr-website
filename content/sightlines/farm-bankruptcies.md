...
Each bar is one year's count of farmer bankruptcy filings in the United States, with the option to normalize the data per 1,000 farms. Notably:
...
A subtler feature is the low baseline of 1945–1975, when American agriculture [consolidated](/sightlines/farm-consolidation/) into fewer, larger, and subsidized farms. Consolidation, not bankruptcy, drove farmers exiting agriculture.
